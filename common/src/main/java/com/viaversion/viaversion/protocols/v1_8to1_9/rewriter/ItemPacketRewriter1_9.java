            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    for (short i = 0; i < stacks.length; i++) {
                        ...
                        if (showShieldWhenSwordInHand) {
                            inventoryTracker.setItemId((byte) windowId, i, stack == null ? 0 : stack.identifier());
                        }
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    if (showShieldWhenSwordInHand) {
                        ...
                        // Update item in slot
                        inventoryTracker.setItemId((byte) 0, slotID, stack == null ? 0 : stack.identifier());
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    if (throwItem) {
                        // Send a packet wiping the slot
                        wrapper.create(ClientboundPackets1_9.CONTAINER_SET_SLOT, w -> {
                            w.write(Types.BYTE, (byte) windowID);
                            w.write(Types.SHORT, slot);
                            w.write(Types.ITEM1_8, null);
                        }).scheduleSend(Protocol1_8To1_9.class);
                        // Finally reset to simulate throwing item
