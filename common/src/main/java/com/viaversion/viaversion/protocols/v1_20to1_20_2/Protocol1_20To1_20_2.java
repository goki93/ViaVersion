...
public final class Protocol1_20To1_20_2 extends AbstractProtocol<ClientboundPackets1_19_4, ClientboundPackets1_20_2, ServerboundPackets1_19_4, ServerboundPackets1_20_2> {
    ...
    protected void registerPackets() {
        ...
        registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.UPDATE_TAGS.getId(), wrapper -> {
            tagRewriter.getGenericHandler().handle(wrapper);
            wrapper.resetReader();
            wrapper.user().put(new LastTags(wrapper));
        });
        ...
        registerServerbound(State.LOGIN, ServerboundLoginPackets.HELLO.getId(), wrapper -> {
        ...
        registerClientbound(State.LOGIN, ClientboundLoginPackets.GAME_PROFILE.getId(), wrapper -> {
